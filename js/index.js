...
var view = {
    ...
    questionBlockRender: function (elem, index, tagstr) {
        return '<div class="question" data-id="' + index + '"><a href="#" class="linker"><div class="question__vav" data-flagger="1">' + view.votesBtnRender(elem.votes) +
